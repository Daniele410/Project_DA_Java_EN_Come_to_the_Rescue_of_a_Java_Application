 ...
 * chaînes, pouvant contenir de nombreux doublons. L'implémentation n'a pas
 * besoin de trier la liste / The implementation does not need to order the list
 * 
 */
public interface ISymptomReader {
	 ...
	 *         donnée / raw listing of all Symptoms obtained from a data source
	 */
